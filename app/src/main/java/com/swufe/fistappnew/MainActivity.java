...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, Runnable, AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        url = "https://it.swufe.edu.cn"+url.substring(2);
        Log.i("Note","url="+url);
    ...
    public void run() {
        ...
        try {
            ...
            Elements titles = doc.getElementsByClass("article-showTitle");
            Elements urls = doc.getElementsByAttributeValueStarting("href","../info");
            //Log.i("Note","run:  article-showTitle"+ titles);
            int i = 0;
            for(Element title:titles){
                Log.i("Note","run:  article-showTitle:"+ title.text());
